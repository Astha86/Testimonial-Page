...
const Testimonials = (props) => {
  ...
  function surpriseHandler(){
    //Math.floor() = value ko roundoff kr k int type bna rha h
  ...
  return (
    ...
    <div className="w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md">
      ...
      <div className="mt-6">
        ...
        className="bg-violet-400 cursor-pointer hover:text-violet-500 transition-all duration-200 px-10 py-2 text-white rounded-md font-bold text-lg">
          Surprise me
        </button>
      </div>
